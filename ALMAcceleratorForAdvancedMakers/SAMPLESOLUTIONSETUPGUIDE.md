...
1. Now that the ALM Accelerator Sample Solution is imported into Dataverse you can push your changes to Git using the **Push Changes to Git** button for the ALM Accelerator Sample Solution.
   ...
   - Note that the first time you run the pipeline, you may need to give it permission to run (see the [Troubleshooting](./SETUPGUIDE.md#Troubleshooting) section of the Setup Guide for more information)
